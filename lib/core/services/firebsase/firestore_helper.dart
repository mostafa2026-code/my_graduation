...
class FirestoreHelper {
  ...
  static savePesonalHistory(PatientPersonalHistory patient){
    _firestore.collection(patientsCollection).doc(patient.id).set(patient.toJson());
  }

  static saveComplainAnalysis(PatientcomplainAnalysis analysis){
    _firestore.collection(patientsCollection).doc(analysis.id).set(analysis.toJson());
  }
