...
List<QAndAModel> drRecordQA = [
  ...
  QAndAModel(
    ...
    answer: "Open the patient's record, navigate to 'Diagnosis', enter details, and save."
  ),
  QAndAModel(
    question: "How to schedule an appointment?",
    answer: "Open the 'Appointments' tab, select patient, choose date and time, and confirm."
  ),
  QAndAModel(
    question: "How to generate a medical report?",
    answer: "Select the patient, go to 'Reports', choose report type, and click 'Generate'."
  ),
  QAndAModel(
    question: "How to delete a patient record?",
    answer: "Open the patient's record, click 'Delete', and confirm the action."
  ),
  QAndAModel(
    question: "How to search for a patient?",
    answer: "Use the search bar on the main screen, type the patient’s name, and select from results."
  ),
  QAndAModel(
